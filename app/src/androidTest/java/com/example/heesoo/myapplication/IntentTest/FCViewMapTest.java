...
public class FCViewMapTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    public FCViewMapTest() {
        ...
        Double lat = Double.valueOf(53.5444);
        Double lon = Double.valueOf(113.4909);
