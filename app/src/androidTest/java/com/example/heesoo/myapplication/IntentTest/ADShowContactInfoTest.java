...
public class ADShowContactInfoTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    public ADShowContactInfoTest() {
    ...
    public void testShowCInfo (){
        ...
        //
        //view bidder profile
        solo.clickOnButton("View Bidder's Profile");
